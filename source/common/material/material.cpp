...
namespace our {
    ...
    void Material::setup() const {
        ...
        pipelineState.setup();//pipline setup call 
        shader->use();//use the progam shader
    ...
    void TintedMaterial::setup() const {
        //TODO: (Req 7) Write this function
        Material::setup();//parent call
        shader->set("tint",tint);///set the uniform location of the vect4 tint
    }
